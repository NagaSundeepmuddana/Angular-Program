...
@Component({
  selector: 'app-qrcn',
  templateUrl: './qrcn.component.html',
  styleUrls: ['./qrcn.component.css']
})
export class qrcnComponent implements OnInit {
  QuoteType: any[] = [{
    "id": "A",
    "text": "All Quotes",
  },
  ...
  constructor( @Inject(Http) http: Http, private metaService: MetadataService, private userService: UserService, public auth: AuthenticationService) {
    ...
    this.dataSource.store = new CustomStore({
      load: function (loadOptions: any) {
        ...
        localStorage.setItem('qrcn_ProductLine', JSON.stringify($('#hidProductlineID').val()) != null && typeof($('#hidProductlineID').val()) != "undefined" ? JSON.stringify($('#hidProductlineID').val()) : null);
        localStorage.setItem('qrcn_Division', JSON.stringify($('#hidDivisionID').val()) != null && typeof($('#hidDivisionID').val()) != "undefined" ? JSON.stringify($('#hidDivisionID').val()) : null);
        localStorage.setItem('qrcn_ContractType', JSON.stringify($('#hidContractTypeID').val()) != null && typeof($('#hidContractTypeID').val()) != "undefined" ? JSON.stringify($('#hidContractTypeID').val()) : null);
        localStorage.setItem('qrcn_ControlNumber',JSON.stringify($('#SearchByContNumber').val()!=null && typeof('#SearchByContNumber').valueOf())!="undefined"? JSON.stringify($('#SearchByContNumber').val()):null);
        localStorage.setItem('qrcn_ProjectName', JSON.stringify($('#SearchByProjName').val()) != null && typeof($('#SearchByProjName').val()) != "undefined" ? JSON.stringify($('#SearchByProjName').val()) : null);
        localStorage.setItem('qrcn_QuoteBeginDate', JSON.stringify($('#hidStartDate').val()) != null && typeof($('#hidStartDate').val()) != "undefined" ? JSON.stringify($('#hidStartDate').val()) : null);
        localStorage.setItem('qrcn_QuoteEndDate', JSON.stringify($('#hidEndDate').val()) != null && typeof($('#hidEndDate').val()) != "undefined" ? JSON.stringify($('#hidEndDate').val()) : null);
        localStorage.setItem('qrcn_StateID', JSON.stringify($('#hidStateID').val()) != null && typeof($('#hidStateID').val()) != "undefined" ? JSON.stringify($('#hidStateID').val()) : null);
        localStorage.setItem('qrcn_IsMasterQuote', JSON.stringify($('#hidQuoteList').val()) != null && typeof($('#hidQuoteList').val()) != "undefined" ? JSON.stringify($('#hidQuoteList').val()) : null);
        localStorage.setItem('qrcn_Contact', JSON.stringify($('#SearchByContact').val()) != null && typeof($('#SearchByContact').val()) != "undefined" ? JSON.stringify($('#SearchByContact').val()) : null);
         localStorage.setItem('qrcn_BusinessManager', JSON.stringify($('#BusinessManager').val()) != null && typeof($('#BusinessManager').val()) != "undefined" ? JSON.stringify($('#BusinessManager').val()) : null);
        localStorage.setItem('qrcn_Status', JSON.stringify($('#hidEditQuoteStatus').val()) != null && typeof($('#hidEditQuoteStatus').val()) != "undefined" ? JSON.stringify($('#hidEditQuoteStatus').val()) : null);
        ...
        return http.get(EndPointsConfig.HostName + EndPointsConfig.QuotesReportbyControlNumberEndPoint.replace('/', '') + params)
          .toPromise()
          .then(response => {
  ...
  GetAllQuoteReportbycontrolno() { 
    this.metaService.GetAllQuoteReportbycontrolno().subscribe(data => {
  ...
  ClearFilters() { 
    ...
    localStorage.removeItem('qrcn_ProductLine');
    localStorage.removeItem('qrcn_Division');
    localStorage.removeItem('qrcn_ContractType');
    localStorage.removeItem('qrcn_ControlNumber');
    localStorage.removeItem('qrcn_ProjectName');
    localStorage.removeItem('qrcn_QuoteBeginDate');
    localStorage.removeItem('qrcn_QuoteEndDate');
    localStorage.removeItem('qrcn_StateID');
    localStorage.removeItem('qrcn_IsMasterQuote');
    localStorage.removeItem('qrcn_Contact');
    localStorage.removeItem('qrcn_BusinessManager');
    localStorage.removeItem('qrcn_Status');
  ...
  PDFGridData() {
  var _ProductLine = JSON.parse(localStorage.getItem('qrcn_ProductLine')) != null && localStorage.getItem('qrcn_ProductLine') != "null" ? JSON.parse(localStorage.getItem('qrcn_ProductLine')) : null ;
  var _Division = JSON.parse(localStorage.getItem('qrcn_Division')) != null && localStorage.getItem('qrcn_Division') != "null" ? JSON.parse(localStorage.getItem('qrcn_Division')) : null ;
  var _ControlNumber = JSON.parse(localStorage.getItem('qrcn_ControlNumber')) != null && localStorage.getItem('qrcn_ControlNumber') != "null" ? JSON.parse(localStorage.getItem('qrcn_ControlNumber')) : null ;    
  var _ProjectName = JSON.parse(localStorage.getItem('qrcn_ProjectName')) != null && localStorage.getItem('qrcn_ProjectName') != "null" ? JSON.parse(localStorage.getItem('qrcn_ProjectName')) : null ;    
  var _QuoteBeginDate = JSON.parse(localStorage.getItem('qrcn_QuoteBeginDate')) != null && localStorage.getItem('qrcn_QuoteBeginDate') != "null" ? JSON.parse(localStorage.getItem('qrcn_QuoteBeginDate')) : null ;
  var _QuoteEndDate = JSON.parse(localStorage.getItem('qrcn_QuoteEndDate')) != null && localStorage.getItem('qrcn_QuoteEndDate') != "null" ? JSON.parse(localStorage.getItem('qrcn_QuoteEndDate')) : null ; 
  var _ContractType = JSON.parse(localStorage.getItem('qrcn_ContractType')) != null && localStorage.getItem('qrcn_ContractType') != "null" ? JSON.parse(localStorage.getItem('qrcn_ContractType')) : null ;
  var _customerName = JSON.parse(localStorage.getItem('qrcn_Contact')) != null && localStorage.getItem('qrcn_Contact') != "null" ? JSON.parse(localStorage.getItem('qrcn_Contact')) : null ;
  var _state = JSON.parse(localStorage.getItem('qrcn_StateID')) != null && localStorage.getItem('qrcn_StateID') != "null" ? JSON.parse(localStorage.getItem('qrcn_StateID')) : null ;  
  var _BusinessManager = JSON.parse(localStorage.getItem('qrcn_BusinessManager')) != null && localStorage.getItem('qrcn_BusinessManager') != "null" ? JSON.parse(localStorage.getItem('qrcn_BusinessManager')) : null;
  var _IsMasterQuote = JSON.parse(localStorage.getItem('qrcn_IsMasterQuote')) != null && localStorage.getItem('qrcn_IsMasterQuote') != "null" ? JSON.parse(localStorage.getItem('qrcn_IsMasterQuote')) : null ;  
  var _Status = JSON.parse(localStorage.getItem('qrcn_Status')) != null && localStorage.getItem('qrcn_Status') != "null" ? JSON.parse(localStorage.getItem('qrcn_Status')) : null ;
  ...
  var _searchparams = {
    ...
    this.metaService.PDFQuoteReportbycontrolno(_searchparams).subscribe(data => {
      if (data) {
        window.open(data, "_blank");
      } else {
